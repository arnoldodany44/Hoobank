...
const Billing = () => (
    <section id="product" className={layout.sectionReverse}>
      ...
      <div className={layout.sectionInfo}>
        <h2 className={styles.heading2}>Easily control your <bt className="sm:block hidden"/>
        billing & invoicing.</h2>
        <p className={`${styles.paragraph} max-w-[470px] mt-5`}>
          Lorem ipsum dolor sit amet consectetur adipisicing elit. 
          Totam aliquid sint et earum odit minus, nemo eligendi
          exercitationem suscipit necessitatibus numquam, recusandae,
          quos neque debitis?
        </p>
